...
map("x", "<leader>p", [["_dP]], { desc = "Delete and Paste", silent = true })

-- Yank to sys clipboard
map({ "n", "v" }, "<leader>y", [["+y]], { desc = "Yank To System Clipboard", silent = true })
map("n", "<leader>Y", [["+Y]], { desc = "Yank To System Clipboard", silent = true })

-- Delete to void register
map({ "n", "v" }, "<leader>d", [["_d]], { desc = "Delete (Not Cut)", silent = true })

-- Find and Replace
map("n", "<A-s>", [[:%s/\<<C-r><C-w>\>/<C-r><C-w>/gI<Left><Left><Left>]], { desc = "Find and Replace", silent = false })
...
-- floating terminal
local mrxterm = function() Util.float_term(nil, { cwd = Util.get_root() }) end
map("n", "<leader>ft", mrxterm, { desc = "Terminal (root dir)" })
map("n", "<leader>fT", function() Util.float_term() end, { desc = "Terminal (cwd)" })
map("n", "<c-/>", mrxterm, { desc = "Terminal (root dir)" })
map("n", "<c-_>", mrxterm, { desc = "which_key_ignore" })
